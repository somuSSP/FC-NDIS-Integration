...
namespace FC_NDIS.Controllers
{
    ...
    [ApiController]
    public class SalesforceRESTAPIController : ControllerBase
    {
        private readonly ILogger _logger;
        private readonly IntegrationAppSettings _integrationAppSettings;
        public SalesforceRESTAPIController(IntegrationAppSettings integrationAppSettings, ILogger<SalesforceRESTAPIController> logger)
        {
