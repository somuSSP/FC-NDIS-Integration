...
namespace FC_NDIS.Controllers
{
    ...
    public class FCIntegrationController : ControllerBase
    {
        ...
        //public Response IntegerateResource_Post(int ResourceId)
        //{
        //    Response rs = new Response();
        //    try
        //    {
        ...
        //        var tokeninfo = fca.GetAccessToken(url);
        //        _logger.LogInformation("IntegerateAssets Token:" + tokeninfo.Token);
        //        if (fca.PostResource(_integrationAppSettings.ClientID, tokeninfo.UserId, tokeninfo.Token, ResourceId))
        //        {
        //            rs.ResponseCode = 200;
        //            rs.Message = "Integrated Successfully";
        //        }
        ...
        //[HttpPut("PutResource")]
        //public Response IntegerateResource_Put(int ResourceId)
        //{
        //    Response rs = new Response();
        //    try
        //    {
        ...
        //        var tokeninfo = fca.GetAccessToken(url);
        //        _logger.LogInformation("IntegerateAssets Token:" + tokeninfo.Token);                
        //        if (fca.PutResource(_integrationAppSettings.ClientID, tokeninfo.UserId, tokeninfo.Token, ResourceId))
        //        {
        //            rs.ResponseCode = 200;
        //            rs.Message = "Integrated Successfully";
        //        }
